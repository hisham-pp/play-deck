...
export const AVAILABLE_GAMES_1: GameDefinition[] = [
  ...
  },
  {
    ...
    players: { min: 1, max: 1 },
    status: STATUS_AVAILABLE,
    thumbnailUrl: '/games/stickman-parkour/icon.svg',
    bannerUrl: '/games/stickman-parkour/cover.svg',
    ...
    controls: [
      ...
      { action: 'Jump & Wall Vault', key: 'Space / W / ArrowUp', touchAction: 'Tap Jump' },
      { action: 'Slide & Roll', key: 'S / ArrowDown', touchAction: 'Tap Slide' },
    ],
  },
  {
    id: 'stickman-shooter',
    ...
    players: { min: 1, max: 1 },
    status: STATUS_AVAILABLE,
    thumbnailUrl: '/games/stickman-shooter/icon.svg',
    bannerUrl: '/games/stickman-shooter/cover.svg',
  ...
  },
  {
    ...
    players: { min: 1, max: 2 },
    status: STATUS_AVAILABLE,
    thumbnailUrl: '/games/stickman-racing/icon.svg',
    bannerUrl: '/games/stickman-racing/cover.svg',
  ...
  },
  {
    ...
    players: { min: 1, max: 2 },
    status: STATUS_AVAILABLE,
    thumbnailUrl: '/games/stickman-sword-fight/icon.svg',
    bannerUrl: '/games/stickman-sword-fight/cover.svg',
  ...
  },
  {
    ...
    players: { min: 1, max: 1 },
    status: STATUS_AVAILABLE,
    thumbnailUrl: '/games/stickman-ninja/icon.svg',
    bannerUrl: '/games/stickman-ninja/cover.svg',
  ...
  },
  {
    ...
    players: { min: 1, max: 2 },
    status: STATUS_AVAILABLE,
    thumbnailUrl: '/games/stickman-basketball/icon.svg',
    bannerUrl: '/games/stickman-basketball/cover.svg',
