...
export const stickmanShooterContent: GameContent = {
  id: 'stickman-shooter',
  seo: {
  ...
  controls: [
    { key: 'Mouse Move / Drag', action: 'Aim crosshairs at hostile targets' },
    { key: 'Left Click / Tap', action: 'Fire currently equipped weapon' },
    { key: 'S / ArrowDown / Space', action: 'Toggle duck and cover posture' },
    { key: 'R / Tap Ammo Bar', action: 'Reload magazine with fresh rounds' },
  ],
  tips: [
