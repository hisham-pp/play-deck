...
export const flappyArcadeContent: GameContent = {
  id: 'flappy-arcade',
  seo: {
  ...
  controls: [
    { key: 'Space / ↑ / W', action: 'Fire thruster (gain altitude)' },
    { key: 'Left Click / Tap', action: 'Mobile / mouse thrust' },
    { key: 'P', action: 'Pause / resume flight' },
  ],
  tips: [
