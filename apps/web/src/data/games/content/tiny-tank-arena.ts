...
export const tinyTankArenaContent: GameContent = {
  id: 'tiny-tank-arena',
  seo: {
  ...
  controls: [
    { key: 'W / S or Up / Down', action: 'Drive tank forward or reverse' },
    { key: 'A / D or Left / Right', action: 'Steer tank hull left or right' },
    { key: 'Mouse Movement', action: 'Aim turret independently in 360 degrees' },
    { key: 'Left-Click / Spacebar', action: 'Fire primary cannon or special weapon' },
    { key: '1 to 6 Number Keys', action: 'Cycle and switch equipped special munitions' },
    { key: 'Esc', action: 'Pause match or return to deployment bay' },
  ],
  rules: [
    {
