...
export const stickmanRunnerContent: GameContent = {
    ...
    howToPlay: [
        ...
        },
        {
            ...
            description: 'Leap over low barriers and observe incoming patterns before your rhythm breaks.',
        },
        {
            title: 'Collect energy orbs',
            description: 'Grab glowing pickups to stack bonus points and sustain momentum through the speed ramp.',
        },
        {
            title: 'Stay alive and chase the score',
            description: 'The longer you survive and the faster the pace climbs, the higher your score climbs.',
        },
    ],
    rules: [
        {
        ...
        },
        {
            ...
            description: 'Collecting bright reward cores awards bonus points and creates a higher-velocity chase.',
        },
        {
            title: 'High score persists locally',
            description: 'Your best result is kept in the browser so each run builds toward a new record.',
        },
    ],
    controls: [
    ...
    faq: [
        ...
        },
        {
            ...
            answer: 'Yes. Your high score is stored in the local browser profile for repeat challenge runs.',
        },
        {
            question: 'Can I play on mobile?',
            answer: 'Yes. The game supports tap controls in addition to keyboard input for quick play on phones and tablets.',
        },
    ],
};
