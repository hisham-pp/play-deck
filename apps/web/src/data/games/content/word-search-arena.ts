...
export const wordSearchArenaContent: GameContent = {
  ...
  controls: [
    { key: 'Click + Drag', action: 'Select a straight line of letters to form a word.' },
    {
      key: 'Touch + Swipe',
      action: 'Mobile-friendly touch selection — drag in any straight direction.',
    },
    { key: 'Release', action: 'Submit your selection and attempt to claim the word.' },
  ],
  tips: [
