...
export const trustOrBetrayContent: GameContent = {
  id: 'trust-or-betray',
  seo: {
  ...
  controls: [
    { key: 'C', action: 'Select Cooperate decision' },
    { key: 'B', action: 'Select Betray decision' },
    { key: 'Enter', action: 'Confirm and lock in secret decision' },
    { key: 'Mouse / Touch', action: 'Tap options, accusation pills, or candidate cards' },
  ],
  rules: [
    {
