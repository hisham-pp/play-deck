...
export const dontWakeTheGiantContent: GameContent = {
  ...
  controls: [
    ...
    { key: 'Shift', action: 'Run — fast and loud' },
    { key: 'C / Ctrl', action: 'Tiptoe — quiet and slow' },
    { key: 'E / Space', action: 'Take the treasure or charm in reach' },
    { key: 'Touch / On-Screen Pad', action: 'Mobile stick, gait toggle and take button' },
  ],
  tips: [
