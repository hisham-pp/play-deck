...
export const sudokuContent: GameContent = {
  id: 'sudoku',
  seo: {
  ...
  controls: [
    { key: 'Arrow keys / WASD', action: 'Move selection' },
    { key: '1 – 9', action: 'Place digit' },
    { key: 'Shift + 1 – 9', action: 'Toggle pencil mark' },
    { key: '0 / Backspace', action: 'Clear cell' },
    { key: 'N / Space', action: 'Toggle note mode' },
    { key: 'U / Ctrl+Z', action: 'Undo' },
    { key: 'H', action: 'Reveal a hint' },
