...
export const alibiContent: GameContent = {
  id: 'alibi',
  seo: {
  ...
  controls: [
    ...
    { key: 'Vote Button', action: 'Select the player whose story you believe has inconsistencies' },
    { key: 'Microphone', action: 'Compare stories and probe for inconsistencies on voice chat' },
    { key: 'Discussion Phase', action: 'Host advances phases when ready' },
  ],
  tips: [
