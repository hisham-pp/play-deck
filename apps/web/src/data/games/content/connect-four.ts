...
export const connectFourContent: GameContent = {
  id: 'connect-four',
  seo: {
  ...
  controls: [
    { key: '← / →', action: 'Move drop cursor' },
    { key: '↓ / Enter / Space', action: 'Drop disc in selected column' },
    { key: 'R', action: 'Restart game' },
    { key: 'Mouse / touch', action: 'Click a column to drop' },
  ],
  tips: [
