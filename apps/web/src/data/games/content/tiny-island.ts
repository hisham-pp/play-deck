...
export const tinyIslandContent: GameContent = {
  id: 'tiny-island',
  seo: {
  ...
  controls: [
    { key: 'W / A / S / D or Arrows', action: 'Move to adjacent tile' },
    { key: 'G', action: 'Gather / scavenge resources' },
    { key: 'Space', action: 'Pass remainder of turn' },
    { key: 'Mouse / Touch', action: 'Click tiles and action buttons' },
  ],
  tips: [
