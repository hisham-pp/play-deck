...
export const stickmanParkourContent: GameContent = {
  id: 'stickman-parkour',
  seo: {
  ...
  controls: [
    { key: 'D / Right Arrow', action: 'Sprint forward / Accelerate' },
    { key: 'A / Left Arrow', action: 'Brake / Decelerate' },
    { key: 'Space / W / Up Arrow', action: 'Jump / Double Jump / Wall Kick' },
    { key: 'S / Down Arrow', action: 'Slide under low obstacles / Roll landing' },
  ],
  tips: [
