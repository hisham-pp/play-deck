...
export const runicMemoryContent: GameContent = {
  id: 'runic-memory',
  seo: {
  ...
  controls: [
    { key: 'Arrow keys', action: 'Move tile selection' },
    { key: 'Space / Enter', action: 'Flip selected tile' },
    { key: 'R', action: 'Restart board' },
    { key: 'Mouse / touch', action: 'Click or tap a tile' },
  ],
  tips: [
