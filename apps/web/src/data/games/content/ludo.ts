...
export const ludoContent: GameContent = {
  id: 'ludo',
  seo: {
  ...
  controls: [
    { key: 'Click / tap die', action: 'Roll the 3D physics die' },
    { key: 'Click / tap token', action: 'Move the selected token' },
    { key: 'Drag', action: 'Orbit the board camera' },
  ],
  tips: [
