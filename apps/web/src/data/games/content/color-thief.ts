...
export const colorThiefContent: GameContent = {
  id: 'color-thief',
  seo: {
  ...
  controls: [
    { key: 'Arrow keys / WASD', action: 'Move across the grid' },
    { key: 'Enter / Space', action: 'Claim the focused tile, or pick it as an ability target' },
    { key: 'Q', action: 'Aim your colour’s ability' },
    { key: 'E', action: 'End your turn' },
    { key: 'Escape', action: 'Cancel an ability you are aiming' },
    { key: 'Mouse / touch', action: 'Tap a tile to claim or target it' },
  ],
  tips: [
