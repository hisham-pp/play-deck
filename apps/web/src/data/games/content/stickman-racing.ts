...
export const stickmanRacingContent: GameContent = {
  id: 'stickman-racing',
  seo: {
  ...
  controls: [
    { key: 'A / D or Left / Right', action: 'Shift between lanes 1, 2, and 3' },
    { key: 'Space / W / Up Arrow', action: 'Jump over track hurdles and barriers' },
    { key: 'Shift / Turbo Button', action: 'Activate high-speed slipstream boost' },
    { key: 'P / Escape', action: 'Pause / Resume current race' },
  ],
  tips: [
