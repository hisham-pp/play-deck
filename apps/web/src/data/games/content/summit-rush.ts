...
export const summitRushContent: GameContent = {
  id: 'summit-rush',
  seo: {
  ...
  rules: [
    ...
    },
    {
      ...
      description:
        'If the driver\u2019s head touches the ground, the run is over regardless of fuel.',
    },
    {
  ...
  controls: [
    { key: 'D / →', action: 'Throttle' },
    { key: 'A / ←', action: 'Brake / reverse' },
    { key: 'Space / Enter', action: 'Start / throttle' },
    { key: 'P / Esc', action: 'Pause / resume' },
    { key: 'R', action: 'Restart run' },
    { key: 'Touch pedals', action: 'Gas and brake on mobile' },
  ],
  tips: [
