...
export const chessContent: GameContent = {
  id: 'chess',
  seo: {
  ...
  controls: [
    { key: 'Click / tap piece', action: 'Select and show legal moves' },
    { key: 'Click / tap square', action: 'Move to a highlighted square' },
    { key: 'Drag', action: 'Orbit the 3D board' },
    { key: 'Arrow keys', action: 'Navigate squares (accessible grid)' },
    { key: 'Enter / Space', action: 'Select or confirm square' },
  ],
  tips: [
