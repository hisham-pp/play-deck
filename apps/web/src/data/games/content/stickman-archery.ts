...
export const stickmanArcheryContent: GameContent = {
  id: 'stickman-archery',
  seo: {
  ...
  controls: [
    { key: 'Mouse Drag / Touch Drag', action: 'Aim bow angle and adjust pull tension' },
    { key: 'Release Drag', action: 'Loose arrow toward target' },
    { key: 'Next Shot Button', action: 'Load the next arrow onto your bowstring' },
    { key: 'Restart Button', action: 'Reset your archery challenge from round 1' },
  ],
  tips: [
