...
export const penFightContent: GameContent = {
  id: 'pen-fight',
  seo: {
  ...
  controls: [
    { key: 'Drag from pen', action: 'Aim and set power' },
    { key: 'Release', action: 'Flick the pen' },
    { key: 'Drag empty space', action: 'Orbit the camera' },
  ],
  tips: [
