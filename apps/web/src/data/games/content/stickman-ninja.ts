...
export const stickmanNinjaContent: GameContent = {
  id: 'stickman-ninja',
  seo: {
  ...
  tagline: 'Slip through shadows, throw aerodynamic shurikens, and silence guards before the alarm sounds.',
  overview: [
  ...
  controls: [
    { key: 'A / D or Left / Right', action: 'Sneak / Walk' },
    { key: 'W / Up Arrow', action: 'Jump / Rafter Vault' },
    { key: 'S / Down Arrow', action: 'Crouch / Hide in Shadow' },
    { key: 'Left Click', action: 'Aim & Throw Shuriken' },
    { key: 'E / Space', action: 'Deploy Smoke Bomb' },
    { key: 'F', action: 'Silent Takedown (Behind Target)' },
  ],
  tips: [
