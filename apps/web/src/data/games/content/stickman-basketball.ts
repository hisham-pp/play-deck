...
export const stickmanBasketballContent: GameContent = {
  ...
  tagline: 'Break ankles with swift crossovers, time your arc jump shots, and shatter rims with monster dunks.',
  overview: [
  ...
  controls: [
    { key: 'A / D or Left / Right', action: 'Move / Drive Lane' },
    { key: 'Space / J', action: 'Jump / Shoot / Dunk (Hold & Release)' },
    { key: 'K / Shift', action: 'Crossover / Steal' },
    { key: 'W / Up Arrow', action: 'Contest / Block' },
  ],
  tips: [
