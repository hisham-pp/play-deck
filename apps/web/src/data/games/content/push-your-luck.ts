...
export const pushYourLuckContent: GameContent = {
  id: 'push-your-luck',
  seo: {
  ...
  controls: [
    { key: 'P / Space / ↑', action: 'Push — draw another card' },
    { key: 'B / Enter / ↓', action: 'Bank the pot and pass the turn' },
    { key: 'R', action: 'Start a new match' },
    { key: 'Mouse / touch', action: 'Tap the Push and Bank buttons' },
  ],
  tips: [
