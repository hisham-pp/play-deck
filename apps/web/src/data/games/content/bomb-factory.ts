...
export const bombFactoryContent: GameContent = {
  id: 'bomb-factory',
  seo: {
  ...
  controls: [
    { key: 'Mouse / Touch', action: 'Select part, bay, tool, and adjust dial' },
    { key: 'Enter / Engage', action: 'Commit current step assembly' },
    { key: 'V / Space', action: 'Push-to-talk voice communication' },
    { key: 'Tab', action: 'Toggle dossier view' },
  ],
  tips: [
