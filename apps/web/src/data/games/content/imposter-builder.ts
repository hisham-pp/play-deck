...
export const imposterBuilderContent: GameContent = {
  id: 'imposter-builder',
  seo: {
  ...
  controls: [
    { key: 'Color Palette', action: 'Select the color for your next block placement' },
    { key: 'Grid Cells', action: 'Tap/click cells to toggle block fill on the 8×8 canvas' },
    { key: 'Reveal Button (Host)', action: 'Trigger simultaneous reveal when build time ends' },
    { key: 'Vote Button', action: 'Select the player you believe is the Imposter' },
    { key: 'Microphone', action: 'Discuss, bluff, and deduce via voice chat' },
  ],
  tips: [
