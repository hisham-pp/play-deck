...
export const wordChainContent: GameContent = {
  id: 'word-chain',
  seo: {
  ...
  controls: [
    { key: 'A–Z', action: 'Type your word' },
    { key: 'Enter', action: 'Play the word' },
    { key: 'Backspace', action: 'Correct your entry' },
    { key: 'Tab', action: 'Move to the pause and rules controls' },
    { key: 'Click / tap', action: 'Pause, resume or change the rules' },
  ],
  tips: [
