...
export const gravityGolfContent: GameContent = {
  id: 'gravity-golf',
  seo: {
  ...
  controls: [
    { key: '1 to 5', action: 'Select gravity object tool' },
    { key: 'Left Click / Drag', action: 'Deploy or reposition gravity field' },
    { key: 'Spacebar', action: 'Launch orb or reset ball to tee' },
    { key: 'R', action: 'Reset hole and clear placed fields' },
    { key: 'Delete / Backspace', action: 'Remove highlighted gravity object' },
  ],
  rules: [
    {
