...
export const minesweeperContent: GameContent = {
  id: 'minesweeper',
  seo: {
  ...
  controls: [
    ...
    { key: 'Space / Enter', action: 'Reveal selected cell' },
    { key: 'F', action: 'Flag selected cell' },
    { key: 'C', action: 'Chord selected cell' },
    { key: 'R', action: 'Restart board' },
    { key: '1 / 2 / 3', action: 'New beginner / intermediate / expert board' },
  ],
  tips: [
