...
export const stickmanClimberContent: GameContent = {
  id: 'stickman-climber',
  seo: {
  ...
  controls: [
    { key: 'Space / Attack Button', action: 'Strike enemy with active weapon' },
    { key: 'Level Up Button', action: 'Advance to next floor and upgrade weapon' },
    { key: 'P / Pause Button', action: 'Pause or resume session' },
    { key: 'Restart Button', action: 'Reset your climb back to Level 1' },
  ],
  tips: [
