...
export const spyNetworkContent: GameContent = {
  id: 'spy-network',
  seo: {
  ...
  controls: [
    { key: 'Question & Answer Fields', action: 'Submit your Q&A exchange on your turn' },
    { key: 'Vote Button', action: 'Cast your vote for who you think is the spy' },
    { key: 'Location Guess Dropdown (Spy only)', action: 'Guess the secret location at reveal' },
    { key: 'Microphone', action: 'Discuss, question, and bluff on live voice chat' },
  ],
  tips: [
