...
export const secretSaboteurContent: GameContent = {
  id: 'secret-saboteur',
  seo: {
  ...
  controls: [
    { key: 'Click / Tap', action: 'Select a contribution card or accusation target' },
    { key: 'Enter', action: 'Confirm card lock-in or send chat message' },
    { key: 'Mouse / Touch', action: 'Interact with accusation pills and trial ballot' },
  ],
  rules: [
    {
