...
export interface SnakePlayerCardProps {
  status: SnakeGameStatus;
  highScore: number;
}

export function SnakePlayerCard({ status, highScore }: SnakePlayerCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        {isPlaying && (
          <span className="absolute -bottom-1 -right-1 w-3.5 h-3.5 rounded-full bg-emerald-500 border-2 border-surface-raised animate-ping" />
        )}
      </div>
