        ...
        {state.status === 'level_clear' && (
          <div className="absolute inset-0 flex items-center justify-center bg-black/75 backdrop-blur-sm">
            <div className="text-center p-6 bg-slate-900/90 rounded-2xl border border-cyan-500/40 shadow-2xl max-w-sm">
              <h2 className="text-3xl font-black text-cyan-400 font-mono mb-2">SECTOR INFILTRATED</h2>
              ...
              <Button onClick={handleNextLevel} className="w-full bg-cyan-500 hover:bg-cyan-600 text-slate-950 font-bold">
        ...
        {state.status === 'game_over' && (
          <div className="absolute inset-0 flex items-center justify-center bg-black/75 backdrop-blur-sm">
            <div className="text-center p-6 bg-slate-900/90 rounded-2xl border border-rose-500/40 shadow-2xl max-w-sm">
              <h2 className="text-3xl font-black text-rose-400 font-mono mb-2">SPOTTED & DEFEATED</h2>
              <p className="text-sm text-slate-300 mb-4 font-mono">
              ...
              <Button onClick={handleRestart} className="w-full bg-rose-500 hover:bg-rose-600 text-slate-950 font-bold">
                Try Again
              </Button>
            </div>
          </div>
