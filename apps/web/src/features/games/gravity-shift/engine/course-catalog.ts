...
const HAZARD = 'hazard' as const;
const BOUNCE_PAD = 'bounce-pad' as const;
const CHECKPOINT = 'checkpoint' as const;
const ENERGY_CORE = 'energy-core' as const;
const FINISH = 'finish' as const;
const GRAVITY_DOWN = 'down' as const;
...
export const COURSE_NEON_CIRCUIT: CourseDefinition = {
  ...
  elements: [
    ...
    { id: 'start-bounce', type: BOUNCE_PAD, x: 620, y: 1435, width: 70, height: 15 },
    ...
    { id: 'energy-1', type: ENERGY_CORE, x: 920, y: 1250, width: 30, height: 30 },
    ...
    { id: 'energy-2', type: ENERGY_CORE, x: 1050, y: 400, width: 30, height: 30 },
    ...
    { id: 'desc-bounce-1', type: BOUNCE_PAD, x: 320, y: 535, width: 60, height: 15 },
...
export const COURSE_GRAVITY_WELL: CourseDefinition = {
  ...
  elements: [
    ...
    // Tier 1 Ascension
    { id: 'gw-bounce-1', type: BOUNCE_PAD, x: 780, y: 1585, width: 80, height: 15 },
    { id: 'gw-plat-tier1', type: PLATFORM, x: 900, y: 1350, width: 500, height: 30 },
    { id: 'gw-energy-1', type: ENERGY_CORE, x: 1100, y: 1300, width: 30, height: 30 },
    ...
    { id: 'gw-energy-2', type: ENERGY_CORE, x: 1900, y: 400, width: 30, height: 30 },
    ...
    { id: 'gw-bounce-east', type: BOUNCE_PAD, x: 2450, y: 1285, width: 80, height: 15 },
...
export const COURSE_HYPER_VORTEX: CourseDefinition = {
  ...
  elements: [
    ...
    { id: 'hv-bp-1', type: BOUNCE_PAD, x: 550, y: 1785, width: 80, height: 15 },
    ...
    { id: 'hv-ec-1', type: ENERGY_CORE, x: 950, y: 1400, width: 30, height: 30 },
    ...
    { id: 'hv-ec-2', type: ENERGY_CORE, x: 1800, y: 250, width: 30, height: 30 },
    ...
    { id: 'hv-drop-bp', type: BOUNCE_PAD, x: 2350, y: 1035, width: 70, height: 15 },
