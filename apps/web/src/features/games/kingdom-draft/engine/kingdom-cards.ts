...
function makeCard(
  ...
  return isRare
    ? { id, name, category, icon, basePoints, synergyDescription, synergyPartnerCategory, synergyBonus, isRare }
    : { id, name, category, icon, basePoints, synergyDescription, synergyPartnerCategory, synergyBonus };
}
...
export const KINGDOM_RESOURCE_CARDS: ResourceCard[] = [
  ...
  makeCard('mountain-ridge', 'Mountain Ridge', CAT_LAND, '⛰️', 2, SYN_ADJACENT_DEFENSE_3, CAT_DEFENSE, 3),
  makeCard('sacred-grove', 'Sacred Grove', CAT_LAND, '🌲', 4, SYN_ADJACENT_CULTURE_4, CAT_CULTURE, 4, true),

  // People
  makeCard('peasant-hamlet', 'Peasant Hamlet', CAT_PEOPLE, '🛖', 2, SYN_ADJACENT_LAND_2, CAT_LAND, 2),
  ...
  makeCard('royal-court', 'Royal Court', CAT_PEOPLE, '👑', 5, SYN_ADJACENT_CULTURE_4, CAT_CULTURE, 4, true),

  // Food
  makeCard('wheat-farm', 'Wheat Farm', CAT_FOOD, '🚜', 2, SYN_ADJACENT_LAND_3, CAT_LAND, 3),
  makeCard('orchard-vineyard', 'Orchard Vineyard', CAT_FOOD, '🍇', 3, SYN_ADJACENT_LAND_3, CAT_LAND, 3),
  makeCard('fishing-wharf', 'Fishing Wharf', CAT_FOOD, '🐟', 3, SYN_ADJACENT_PEOPLE_3, CAT_PEOPLE, 3),
  makeCard('windmill-bakery', 'Windmill Bakery', CAT_FOOD, '🥖', 4, SYN_ADJACENT_FOOD_3, CAT_FOOD, 3, true),

  // Defense
  makeCard('wooden-palisade', 'Wooden Palisade', CAT_DEFENSE, '🪵', 2, SYN_ADJACENT_LAND_2, CAT_LAND, 2),
  makeCard('watchtower', 'Watchtower', CAT_DEFENSE, '🏹', 3, SYN_ADJACENT_PEOPLE_3, CAT_PEOPLE, 3),
  makeCard('stone-fortress', 'Stone Fortress', CAT_DEFENSE, '🏰', 4, SYN_ADJACENT_DEFENSE_4, CAT_DEFENSE, 4),
  makeCard('citadel-keep', 'Citadel Keep', CAT_DEFENSE, '🛡️', 6, SYN_ADJACENT_PEOPLE_4, CAT_PEOPLE, 4, true),
  ...
  makeCard('imperial-treasury', 'Imperial Treasury', CAT_GOLD, '💎', 6, SYN_ADJACENT_GOLD_4, CAT_GOLD, 4, true),

  // Culture
  makeCard('monastery-garden', 'Monastery Garden', CAT_CULTURE, '🕯️', 3, SYN_ADJACENT_LAND_3, CAT_LAND, 3),
  makeCard('theater-amphitheater', 'Grand Amphitheater', CAT_CULTURE, '🎭', 3, SYN_ADJACENT_PEOPLE_3, CAT_PEOPLE, 3),
  makeCard('grand-library', 'Grand Library', CAT_CULTURE, '📜', 4, SYN_ADJACENT_CULTURE_4, CAT_CULTURE, 4),
  makeCard('royal-cathedral', 'Spired Cathedral', CAT_CULTURE, '⛪', 6, SYN_ADJACENT_CULTURE_4, CAT_CULTURE, 4, true),
];
