...
export const humanConveyorBeltGame = defineGameModule({
  ...
  controls: [
    {
      key: 'Q / E or ← / →',
      action: 'Tilt platform left or right',
    },
    {
      key: 'W / S or ↑ / ↓',
      action: 'Elevate platform up or down',
    },
    {
      key: 'A / D',
...
export const humanConveyorBeltContent = humanConveyorBeltGame.content;
export const humanConveyorBeltDefinition = humanConveyorBeltGame.definition;
