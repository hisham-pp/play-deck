  ...
  controls: [
    {
      ...
      action: 'Move sprinter in all directions',
    },
    {
      key: 'Spacebar / E',
      action: 'Deploy decoy trap (when equipped)',
    },
    {
      key: 'Touch D-Pad',
      action: 'On-screen virtual directional navigation',
    },
    {
      key: 'Esc',
      action: 'Pause match or return to lobby',
    },
  ],
  tips: [
...
export const lootDashContent = lootDashGame.content;
export const lootDashDefinition = lootDashGame.definition;
