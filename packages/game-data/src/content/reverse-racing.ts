...
export const reverseRacingGame = defineGameModule({
  ...
  controls: [
    ...
    {
      key: 'Spacebar / W / Up',
      action: 'Jump vehicle over obstacles',
    },
    {
      key: 'S / Down',
      action: 'Apply brake deceleration',
    },
    {
      key: '1 to 6',
      action: 'Select obstacle to deploy',
    },
    {
      key: 'Mouse Click',
      action: 'Deploy selected obstacle on target radar',
    },
  ],
  tips: [
...
export const reverseRacingContent = reverseRacingGame.content;
export const reverseRacingDefinition = reverseRacingGame.definition;
