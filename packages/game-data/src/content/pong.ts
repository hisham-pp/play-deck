...
export const pongGame = defineGameModule({
  ...
  controls: [
    {
      key: 'W / S',
      action: 'Player 1 paddle up / down',
    },
    {
      key: '↑ / ↓',
      action: 'Player 2 paddle up / down',
    },
    {
      key: 'Space',
      action: 'Serve / pause',
...
export const pongContent = pongGame.content;
export const pongDefinition = pongGame.definition;
