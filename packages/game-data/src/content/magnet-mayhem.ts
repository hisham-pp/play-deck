...
export const magnetMayhemGame = defineGameModule({
  ...
  controls: [
    {
      key: 'Mouse Movement / Touch',
      action: 'Aim magnetic reticle and flight vector',
    },
    {
      key: 'Left-Click / Space / Z',
      action: 'ATTRACT: Pull towards anchors & slingshot',
    },
    {
      key: 'Right-Click / Shift / X',
      action: 'REPEL: Radial magnetic repulsion shockwave',
    },
    {
      key: 'Mobile Touch Buttons',
...
export const magnetMayhemContent = magnetMayhemGame.content;
export const magnetMayhemDefinition = magnetMayhemGame.definition;
