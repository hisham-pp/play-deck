  ...
  controls: [
    {
      ...
      action: 'Navigator: Steer horizontal movement',
    },
    {
      key: 'Spacebar / W / Up',
      action: 'Motor: Jump and spring bounce',
    },
    {
      key: 'E / S / Down',
      action: 'Motor: Pull levers & toggle door switches',
    },
    {
      key: 'Solo Dual-Control',
      action: 'Use all controls simultaneously in solo mode',
    },
  ],
  tips: [
...
export const sharedBrainContent = sharedBrainGame.content;
export const sharedBrainDefinition = sharedBrainGame.definition;
