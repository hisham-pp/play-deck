...
export const snakeAndLadderGame = defineGameModule({
  ...
  controls: [
    ...
    {
      key: 'Tab / Enter',
      action: 'Move between and activate on-screen controls',
    },
  ],
  tips: [
...
export const snakeAndLadderContent = snakeAndLadderGame.content;
export const snakeAndLadderDefinition = snakeAndLadderGame.definition;
